...
class HoldoutStackableTransformer(BaseStackableTransformer):
    ...
    def __init__(self, estimator, method='auto', scoring=None, holdout_size=.1,
        ...
        super(HoldoutStackableTransformer, self).__init__(
...
class HoldoutWrapper(BaseWrapper):
    ...
    def __init__(self, default_method='auto', default_scoring=None,
                 holdout_size=.1, random_state=42, fit_to_all_data=False):
        _validate_random_state(random_state)

        super(HoldoutWrapper, self).__init__(default_method, default_scoring)
        self.holdout_size = holdout_size
        self.random_state = random_state
        self.fit_to_all_data = fit_to_all_data
    ...
    def wrap_estimator(self, estimator, method=None, **kwargs):
        ...
        return HoldoutStackableTransformer(
            estimator, method=method, scoring=self.default_scoring,

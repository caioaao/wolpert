...
class TimeSeriesStackableTransformer(BaseStackableTransformer):
    ...
    """
    def __init__(self, estimator, method='auto', scoring=None, offset=0,
                 test_set_size=1, min_train_size=1, max_train_size=None,
                 n_cv_jobs=1):
        super(TimeSeriesStackableTransformer, self).__init__(
            estimator, method, scoring)
        self.offset = offset
        self.test_set_size = test_set_size
        self.min_train_size = min_train_size
        self.max_train_size = max_train_size
...
class TimeSeriesWrapper(BaseWrapper):
    ...
    def __init__(self, default_method='auto', default_scoring=None, offset=0,
                 test_set_size=1, min_train_size=1, max_train_size=None,
                 n_cv_jobs=1):
        super(TimeSeriesWrapper, self).__init__(
            default_method, default_scoring)
        self.offset = offset
        self.test_set_size = test_set_size
        self.min_train_size = min_train_size
        self.max_train_size = max_train_size
    ...
    def wrap_estimator(self, estimator, method=None, **kwargs):
        ...
        return TimeSeriesStackableTransformer(
            ...
            scoring=self.default_scoring, offset=self.offset,
